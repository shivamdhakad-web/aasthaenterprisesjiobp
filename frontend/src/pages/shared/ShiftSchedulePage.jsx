    ...
    <div className="w-full max-w-[100vw] overflow-x-hidden space-y-4 p-4 sm:space-y-6 sm:p-6">
      <section className="rounded-2xl border border-[var(--border-strong)] bg-[var(--bg-panel)] p-5">
        ...
        <p className="mt-2 text-sm text-[color:var(--text-secondary)]">
          Yahan se employee-wise ya sabke liye shift timing, weekly duty, aur day/night schedule
          assign kar sakte ho.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-[var(--border-strong)] bg-[var(--bg-panel)] p-5">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row">
          ...
          />
          <button onClick={reset} className="rounded-2xl border border-[var(--border-color)] bg-[var(--bg-soft)] px-4 py-3 font-medium text-[color:var(--text-primary)]">
            Reset Form
          </button>
        </div>
