...
export default function EmployeeAttendanceDashboardPage() {
  ...
  return <div className="w-full p-4 text-[color:var(--text-primary)] sm:p-6">
    <section className="mb-5 overflow-hidden rounded-2xl border border-violet-200 bg-[var(--bg-panel)] shadow-[var(--shadow-soft)]"><div className="flex flex-col gap-4 bg-gradient-to-r from-violet-50 via-white to-cyan-50 px-5 py-5 lg:flex-row lg:items-center lg:justify-between"><div className="flex items-start gap-3"><span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-violet-600 text-gray-50 shadow-sm"><UsersRound size={22} /></span><div><p className="text-[11px] font-bold uppercase tracking-wider text-violet-700">Workforce Intelligence</p><h1 className="mt-1 text-2xl font-black tracking-tight text-black">Attendance & Payroll Pulse</h1><p className="mt-1 text-sm text-[color:var(--text-secondary)]">Monitor attendance patterns, payroll movements, advances, and employee balances.</p></div></div><div className="flex flex-wrap gap-2"><button type="button" onClick={loadData} className="inline-flex items-center gap-2 rounded-xl border border-[var(--border-color)] bg-[var(--bg-panel)] px-4 py-2.5 text-sm font-semibold"><RefreshCw size={16} /> Refresh</button><button type="button" onClick={() => navigate("/admin/employees")} className="inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-semibold text-gray-50"><ArrowLeft size={16} /> Employees & Attendance</button></div></div></section>
