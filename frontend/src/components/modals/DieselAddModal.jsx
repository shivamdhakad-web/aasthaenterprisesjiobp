...
import { addDieselSale } from "../../services/dieselApi"

export default function DieselAddModal({ close, reload }) {
      ...
      <div className="bg-[#0A0D14] border border-[#1A1D26] w-[500px] p-6 rounded-xl">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="bg-[#22C1F1] text-white px-4 py-2 rounded w-full"
          >
            Add
          </button>
