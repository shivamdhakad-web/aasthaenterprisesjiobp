...
//     const { fuelType, liters, rate, date } = req.body;
...
//         await axios.get(
//           `https://api.callmebot.com/whatsapp.php?phone=91${customer.phone}&text=${encodeURIComponent(message)}&apikey=YOUR_API_KEY`
//         );
...
console.log(customer.phone.replace("+",""));
